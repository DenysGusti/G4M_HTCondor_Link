...
class Job:
    def __init__(self, name: str, executable: Path, *, submit_folder: Path = None,
                 ...
                 notification: str = None, when_to_transfer_output: str = None, transfer_input_files: list[Path] = None,
                 transfer_output_files: list[Path] = None, arguments: list[str] = None, queue: int = None):
        self.name: str = name
        ...
        self.transfer_input_files: list[Path] = transfer_input_files
        self.transfer_output_files: list[Path] = transfer_output_files
    ...
    def build(self) -> 'Job':
        ...
        self.lines += [f'{x} = {self.submit_folder / f"{files_name}.{x[:3]}"}'
